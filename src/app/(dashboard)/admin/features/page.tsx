...
export default async function FeaturesPage() {
  ...
  else if (user?.positionDetail === "Asisten Deputi") {
    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="text-slate-500 dark:text-slate-400 mt-2 text-lg">
          Aktifkan atau nonaktifkan akses menu tertentu untuk setiap kelompok pangkat secara dinamis.
        </p>
      </div>
      ...
      <div className="flex items-start gap-3 p-4 rounded-xl bg-blue-500/10 border border-blue-500/20 text-blue-300">
        ...
        <div className="text-sm">
          ...
          <p className="text-blue-300/80">
            Klik tombol toggle di sebelah kanan untuk mengaktifkan (hijau) atau menonaktifkan (abu-abu) setiap fitur per kelompok pangkat. Perubahan berlaku secara langsung dan real-time.
          </p>
        </div>
      </div>
